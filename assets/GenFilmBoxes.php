<?php
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        //Új oszlop-> Poster => Film hozzáadásánál megadunk egy posztert így könnyebb lesz a munka
            ...
            <div class='info'>
                ...
                <div class='times'>
                    <div class='movie-time'>
                        <a class='past'>
                            <span class='time'>
                                <em>Premier: {$row['premier']}</em>
                            </span>
                        </a>
                    </div>
                </div>
                <div class='moretimes'>
                    <a href='./idopont.php?filmid={$row['filmid']}' class='movie-playlist'>Mikor lesz még műsoron?</a>
                </div>
            </div>
        </div>");
        }
